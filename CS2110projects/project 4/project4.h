...
#define SET_DOC_PRESENT(doc_valid_vector, index) ((VALID_MASK<<index)|doc_valid_vector)
...
#define CLEAR_DOC_PRESENT(doc_valid_vector, index) ((~(VALID_MASK<<index))&doc_valid_vector)
